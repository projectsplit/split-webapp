...
export type ExpenseRequest = GroupExpenseRequest | NonGroupExpenseRequest | PersonalExpenseRequest;
export type ExpenseRequestWithType = (GroupExpenseRequest & {
    type?: 'group';
...
export declare enum BudgetScope {
    Personal = 1,
    NonGroup = 2,
    Group = 4
}

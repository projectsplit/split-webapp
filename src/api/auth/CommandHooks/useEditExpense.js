...
export const useEditExpense = (menu, groupId, setIsSubmitting, nonGroupUsers, fromHomeGroup, groupMembers, makePersonalClicked, isNonGroupExpense, selectedExpense) => {
...
const editExpense = async (req) => {
    await apiClient.post('/expenses/edit', req);
};

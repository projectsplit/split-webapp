...
export const useCreateGuest = (groupId, noGroupError, guestName, setGuestName) => {
...
const createGuest = async (groupId, req) => {
    const response = await apiClient.post(`/groups/${groupId}/add-guest`, req);

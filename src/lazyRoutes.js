...
const loaders = {
    ...
    GenerateInvitationCode: () => import('@/pages/GenerateInvitationCode/GenerateInvitationCode'),
    Personal: () => import('@/pages/Personal/Personal').then((m) => ({ default: m.Personal })),
    BudgetActions: () => import('@/pages/Budget/BudgetActions/BudgetActions').then((m) => ({
        default: m.BudgetActions,
    })),
    ManageBudgets: () => import('@/pages/Budget/ManageBudgets/ManageBudgets').then((m) => ({

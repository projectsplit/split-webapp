...
export const buildStartAndEndDates = (cycle, selectedTimeCycleIndex, selectedYear, allWeeksPerYear, timeZone) => {
    let startDate;
    let endDate;
    ...
    switch (cycle) {
        case Frequency.Monthly:
            const allDaysInMonth = getAllDaysInMonth(selectedTimeCycleIndex + 1, selectedYear);
...
const getDateFromWeeksArray = (allWeeksPerYear, selectedTimeCycleIndex, index) => {

...
export const buildLabels = (cycle, selectedTimeCycleIndex, datesToNumbers, monthsAndDaysArrays, fractalFactor) => {
    switch (cycle) {
...
const getFullMonthNames = (monthsAndDaysArrays, index) => {

...
export function BarChart({ selectedCycle, selectedYear, monthsAndDaysArrays, cyclehaschanged, allWeeksPerYear, menu, selectedTimeCycleIndex, startDate, endDate, currency, backendData, isSuccess, timeZone, }) {
    ...
    const options = getChartOptions(isSuccess, monthsAndDaysArrays, selectedCycle.value, labels, selectedYear.value, selectedTimeCycleIndex.value, currency);
    const expenseDataGrouping = (cycle, expenseDataPoints) => {
        switch (cycle) {
            case Frequency.Monthly:

...
export const getChartOptions = (isSuccess, monthsAndDaysArrays, selectedCycle, labels, selectedYear, selectedTimeCycleIndex, currency) => {
        ...
        plugins: {
            ...
            tooltip: {
                yAlign: (ctx) => {
                    ...
                    if (ctx.tooltip.dataPoints[0].raw > 0)
                        return 'top';
                    return 'bottom';
                },
                displayColors: false,
                    ...
                    title: (context) => {
                        ...
                        switch (selectedCycle) {
                            ...
                            case Frequency.Weekly:
                                return (swapMonthDayToDayMonth(convertToFullMonthNames(monthsAndDaysArrays)[selectedTimeCycleIndex])[index] +
                                    ' ' +
                                    selectedYear);

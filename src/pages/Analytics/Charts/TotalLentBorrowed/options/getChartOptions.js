...
export const getChartOptions = (isSuccess, totalLentExt, totalBorrowedExt, selectedCycle, labels, enhancedDatesToNumbers, selectedYear, selectedTimeCycleIndex, currentWeekIndex, hitRadius, fractalFactor, currency) => {
            ...
            datalabels: {
                ...
                align: (context) => {
                    if (totalLentExt !== undefined && totalBorrowedExt !== undefined)
                        ...
                        else if (context.dataset.label === 'Total Lent' &&
                            totalLentExt[context.dataIndex] <
                                totalBorrowedExt[context.dataIndex])
                            return 'bottom';
                        else if (context.dataset.label === 'Total Borrowed' &&
                            totalLentExt[context.dataIndex] <
                                totalBorrowedExt[context.dataIndex]) {
                            return 'top';
                        }
                ...
                formatter: (value, context) => {
                    ...
                    if (context.dataIndex === 0 ||
                        ...
                        if (enhancedDatesToNumbers[context.dataIndex] === 15 &&

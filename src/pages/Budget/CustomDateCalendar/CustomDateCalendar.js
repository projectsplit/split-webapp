...
export default function CustomDateCalendar({ calendarIsOpen, datePeriodClicked, timeZoneId, startDate, endDate, pickingTarget, setError, excludeRefs, }) {
    ...
    return (_jsx(StyledCustomDateCalendar, { ref: calendarRef, children: calendarIsOpen.value && (_jsx(DateTimePicker, { selectedDateTime: selectedDateTime, setSelectedDateTime: handleDateSelection, timeZoneId: timeZoneId, showTimeControls: false, datePeriodClicked: datePeriodClicked, calendarIsOpen: calendarIsOpen })) }));
}

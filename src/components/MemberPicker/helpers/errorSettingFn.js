...
export const errorSettingFn = (description, memberAmounts, setError, errorMenu, selectedCurrency, totalAmount) => {
    ...
    setError(!areNumbersValid && description === 'Participants'

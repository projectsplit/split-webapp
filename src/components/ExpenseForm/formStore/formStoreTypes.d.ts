...
import { ExpenseRequest, FormExpense, GeoLocation, Group, Guest, Label, Member, PickerMember, User, UserInfo } from '../../../types';
...
export interface ExpenseState {
    ...
    setParticipantsByCategory: (updater: CategoryMap<PickerMember[]> | ((prev: CategoryMap<PickerMember[]>) => CategoryMap<PickerMember[]>)) => void;
    setPayersByCategory: (updater: CategoryMap<PickerMember[]> | ((prev: CategoryMap<PickerMember[]>) => CategoryMap<PickerMember[]>)) => void;
    updateParticipantsInCategory: (category: SplitMethod, updater: (prev: PickerMember[]) => PickerMember[]) => void;
    updatePayersInCategory: (category: SplitMethod, updater: (prev: PickerMember[]) => PickerMember[]) => void;
    initialize: (config: {
